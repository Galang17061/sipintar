   ...
   <div class="block-content collapse in">
    ...
    <div class='span12'>
     ...
     <div class="control-group">
      <div class="controls">
       <input class="input-file fileUpload" id="fileInput" 
        ...
        &nbsp;<a href="#" onclick="bank_soal_listening_data.showFileAnswerBefore('<?php echo $jawaban[0]['file_jawaban'] ?>',
     ...
     <div class="control-group">
      <div class="controls">
       <input class="input-file fileUpload" id="fileInput" 
        ...
        &nbsp;<a href="#" onclick="bank_soal_listening_data.showFileAnswerBefore('<?php echo $jawaban[1]['file_jawaban'] ?>',
     ...
     <div class="control-group">
      <div class="controls">
       ...
       <?php if ($jawaban[2]['file_jawaban'] != '') { ?>
        &nbsp;<a href="#" onclick="bank_soal_listening_data.showFileAnswerBefore('<?php echo $jawaban[2]['file_jawaban'] ?>',
     ...
     <div class="control-group">
      <div class="controls">
       ...
       <?php if ($jawaban[3]['file_jawaban'] != '') { ?>
        &nbsp;<a href="#" onclick="bank_soal_listening_data.showFileAnswerBefore('<?php echo $jawaban[3]['file_jawaban'] ?>',
     ...
     <div class="control-group">
      <div class="controls">
       ...
       <?php if ($jawaban[4]['file_jawaban'] != '') { ?>
        &nbsp;<a href="#" onclick="bank_soal_listening_data.showFileAnswerBefore('<?php echo $jawaban[4]['file_jawaban'] ?>',
     ...
     <div class="form-actions">
      <button type="button" class="btn btn-primary" onclick="bank_soal_listening_data.editSoal()">Simpan</button>
      <button type="button" class="btn btn-warning" onclick="bank_soal_listening_data.ambilSimbol()">Ambil Simbol Matematika</button>
